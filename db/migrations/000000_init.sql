...
CREATE TABLE IF NOT EXISTS ad (
	id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	creator_id INT REFERENCES client(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS ad_details (
	id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	ad_id INT UNIQUE REFERENCES ad(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS statistics (
	id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	ad_details_id INT UNIQUE REFERENCES ad_details(id) ON DELETE CASCADE,
