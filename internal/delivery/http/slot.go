...
func (h *SlotHandler) ServeSlot(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Security-Policy", "frame-ancestors 'self' http://localhost:8000 http://89.208.230.119:8000 http://terabithia.online http://localhost:8000 https://adnet.website;")
